...
(function () {
  ...
  function buildPanel() {
    ...
    root.innerHTML = [
      ...
      '    <div class="fabricvton-result">',
      '     <div class="fabricvton-compare" data-role="compare">',
      '      <img alt="Your virtual try-on" data-role="result" />',
      '      <img alt="" aria-hidden="true" class="fabricvton-before" data-role="before" />',
      '      <span class="fabricvton-tag fabricvton-tag-before" aria-hidden="true">Before</span>',
      '      <span class="fabricvton-tag fabricvton-tag-after" aria-hidden="true">After</span>',
  ...
  function setCompare(pos) {
    ...
    els.compare.style.setProperty("--fv-split", pos + "%");
