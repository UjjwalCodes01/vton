...
const pricing = [
	{
		...
		yearlyPrice: "$86/year",
		items: [
			"50 monthly try-ons included",
			"+$0.18 per extra try-on",
	...
	},
	{
		...
		featured: true,
		items: [
			"400 monthly try-ons included",
			"+$0.13 per extra try-on",
			"Lead capture (email collection)",
			"Merchant analytics dashboard",
			"Standard support",
		],
	},
	{
		name: "Pro",
		price: "$99/month",
		yearlyPrice: "$950/year",
		items: [
			"1,000 monthly try-ons included",
	...
	},
	{
		name: "Scale",
		price: "$219/month",
		yearlyPrice: "$2,102/year",
		items: [
			"2,500 monthly try-ons included",
