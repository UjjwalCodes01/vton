...
import { CLOTHSY_HOME, SHOPIFY_APP_STORE_URL } from "../lib/site";
      ...
      <div className={`header-wrapper ${isScrolled ? "is-scrolled" : ""}`}>
        <header className="site-header">
          <div className="site-header-shell">
            <Link className="brand" href={CLOTHSY_HOME} onClick={closeMenu}>
            ...
            <nav className="nav-links">
              <Link href={`${CLOTHSY_HOME}#features`}>Features</Link>
              <Link href={`${CLOTHSY_HOME}#pricing`}>Pricing</Link>
              <Link href={`${CLOTHSY_HOME}#faq`}>FAQ</Link>
        ...
        <div className="mobile-drawer-backdrop" onClick={closeMenu}>
          ...
          >
            ...
            <nav className="mobile-drawer-nav">
              ...
              <Link href={`${CLOTHSY_HOME}#features`} className="mobile-drawer-link" onClick={closeMenu}>
                Features
              </Link>
              <Link href={`${CLOTHSY_HOME}#pricing`} className="mobile-drawer-link" onClick={closeMenu}>
                Pricing Plans
              </Link>
              <Link href={`${CLOTHSY_HOME}#faq`} className="mobile-drawer-link" onClick={closeMenu}>
