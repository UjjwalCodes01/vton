        ...
        <section className="hero about-hero">
          ...
          >
            ...
            <motion.div variants={heroChild} className="about-hero-cta">
              <Link href={CLOTHSY_HOME} className="btn btn-primary">Back to Home</Link>
              <a
          ...
          <FadeUp>
            <div className="about-connect-card">
              ...
              <div className="about-connect-links">
                <a href="mailto:contact@fabricvton.com" className="about-connect-link" id="contact-email">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                    <rect x="2" y="4" width="20" height="16" rx="2" />
                    <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" />
                  </svg>
                  contact@fabricvton.com
                </a>
                <a href="https://www.instagram.com/clothsyai/" target="_blank" rel="noopener noreferrer" className="about-connect-link" id="contact-instagram">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                ...
                <a href="https://x.com/clothsyai" target="_blank" rel="noopener noreferrer" className="about-connect-link" id="contact-twitter">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                  </svg>
                  @clothsyai
                </a>
                <a href="https://www.linkedin.com/company/clothsy/" target="_blank" rel="noopener noreferrer" className="about-connect-link" id="contact-linkedin">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
